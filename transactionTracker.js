                            ...
                            if (nftOfBidder) {
                                ...
                                if (nftOfRecipient.nQuantity === aBids[index].nQuantity) {
                                    ...
                                    let newNFT = new NFT({
                                        ...
                                        sGenre:  nftOfRecipient.sGenre,
                                        sBpm:  nftOfRecipient.sBpm,
                                        skey_equalTo:  nftOfRecipient.skey_equalTo,
                                        skey_harmonicTo:  nftOfRecipient.skey_harmonicTo,
                                        track_cover: nftOfRecipient.track_cover,
